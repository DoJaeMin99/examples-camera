...
def main():
    ...
    default_model = 'Coregleam_panel_model_500_v2.tflite'
    default_labels = 'Coregleam_panel_labels.txt'
    folder_path = '/home/mendel/google-coral/examples-camera/image/panel_image'
    index = 0
    for image in os.listdir(folder_path):
        output = '/home/mendel/google-coral/examples-camera/result_image/panel_result/panel_{}.jpg'.format(index)
